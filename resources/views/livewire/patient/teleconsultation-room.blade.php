    ...
    <div class="rounded-xl border border-zinc-200 bg-white p-8 text-center dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div class="mt-6">
            @if($canJoin)
                ...
                <flux:button href="{{ $this->appointment->zoom_join_url }}" target="_blank" variant="primary" size="lg" icon="video-camera">
                    Join Meeting
                </flux:button>
            ...
            @else
                ...
                <flux:button disabled variant="primary" size="lg" icon="clock">
